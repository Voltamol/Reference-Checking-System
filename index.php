           ...
           if($rowcount==1){
            ...
            $isadmin=$data['is_admin'];
             $_SESSION['isadmin']=$isadmin;
                ...
                if($isadmin==0){
                  header("Location:candidates/candview.php");
                  
                }else{
                 
                  header("Location:admin/index.php");//redir
                }
             }else{
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="candidate_signup.php">Create an account</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bakertilly.co.zw/">B@kertilly</a>
              </div>
