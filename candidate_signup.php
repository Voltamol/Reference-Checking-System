...
if(isset($_POST["submit"])){
  $fname=input_val($_POST["fname"]);
  $lname=input_val($_POST["lname"]);
  $phone=input_val($_POST["phonenumber"]);
  $email=input_val($_POST["email"]);
  $pos=input_val($_POST["position"]);
  $password=input_val($_POST["password"]);
  $address=input_val($_POST["address"]);
  $isadmin=0;


$flags=(mysqli_query($conn,"SELECT * FROM `candidates`WHERE `email`='$email'"));
$flag=$flags->num_rows;
if ($flag==0){
...
if($col){
  $id=$col->num_rows;
  $id++;
  $sql="INSERT INTO `candidates`(`candidate_id`,`first_name`,`last_name`,`phone`,`email`,`address`,`position`)VALUES('$id','$fname','$lname','$phone','$email','$address','$pos')";
  $results = mysqli_query($conn,$sql);
   ...
   $data= mysqli_query($conn,$sql1);
    if($results && $data){
      ...
      $logdata="New candidate ".$fname." ".$lname." has registered";
    ...
    header("Location:candidates/cand.php");
  }else{
    echo "not added please try again";
  }
}
}
else{
  $error= "<div class='alert alert-danger text-center'>Account already exist please login instead</div>";
    }
}
?>
<!DOCTYPE html>
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php
                    ...
                    ?>
                  <form action="candidate_signup.php"  method="post" class="row g-3 needs-validation" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12">
                        ...
                        <input type="text" name="phonenumber" placeholder="07xxxxxxxx" class="form-control" id="yourPhoneNumber" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="position" class="form-control" id="referee-name" placeholder="enter position to apply for" required>
                    </div>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://baketilly.site/">B@kertilly</a>
