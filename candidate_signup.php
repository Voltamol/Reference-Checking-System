...
if($col){
  ...
  $sql="INSERT INTO `candidates`(`candidate_id`,`first_name`,`last_name`,`phone`,`email`)VALUES('$id','$fname','$lname','$phone','$email')";
                  ...
                  <form action="candidate_signup.php"  method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="col-12">
                        ...
                        <input type="number" name="phonenumber" placeholder="07XXXXXXXX" class="form-control" id="yourPhoneNumber" required>
