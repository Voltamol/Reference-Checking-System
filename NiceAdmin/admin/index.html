...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="admin_profile.html">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="candidates.html">
          <i class="bi bi-people"></i>
          <span>Candidates </span>
        </a>
      </li><!-- End Profile Page Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="add admin.html">
      ...
      <div id="footer-logout">
        <button class="btn btn-primary">SignoutSS</button>
      </div>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Reference Status OverView</h1>
      <!--<nav>
        <ol class="breadcrumb">
              ...
              <div class="card-body">
                ...
                <table class="table table-borderless datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>Econet</td>
                      <td><a href="#" class="text-primary">Strive masiyiwa</a></td>
                      <td><span class="badge bg-success">Completed</span></td>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary modal-toggle-button" data-bs-toggle="modal" data-bs-target="#basicModal" style="display: none;">
                      Basic Modal
                    </button>
          ...
          <div class="card">
            <div class="filter">
              ...
              <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <li><a class="dropdown-item filter-item" href="#">Today</a></li>
                <li><a class="dropdown-item filter-item" href="#">This Month</a></li>
                <li><a class="dropdown-item filter-item" href="#">This Year</a></li>
              </ul>
            </div>
            ...
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">29/08/2023</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">29/09/2023</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">27/09/2022</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">28/08/2023</div>
