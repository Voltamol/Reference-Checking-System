...
if(isset($_POST["submit"])){
  ...
  $col=mysqli_query($conn,"SELECT * FROM `ref_responses`");
if($col){
  $id=$col->num_rows;
  $id++;
}
  ...
  $sql1="INSERT INTO`ref_responses`(`ref_id`,`question_id`,`response`)VALUES('$id2','$id','$response')";
      ...
      <div class="card">
        <div class="card-body"><br>
          <div>
            ...
            <input type="range" class="form-range" name="problem_solving" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" name="communication_skills" class="form-range" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" class="form-range"  name="time_management" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" class="form-range" name="creativity" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" class="form-range" name="willingness_to_learn" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" class="form-range" name="team_work" min="0" max="100" id="customRange2">
          ...
          <div>
            ...
            <input type="range" class="form-range"  name="reliability" min="0" max="100" id="customRange2">
