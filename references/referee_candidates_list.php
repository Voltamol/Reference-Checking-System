...
<body>
  ...
  <main id="position" class="position">
    ...
    <section class="section w-100" id="candidates-table">
      <div class="row">
        <div class="col-lg-12">
    ...
    <a href="#candidates-profile" style="display: none;" id="profile-link"></a>
    <!--Profile-->
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 fullName">Kevin Anderson</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Role</div>
                    <div class="col-lg-9 col-md-8 role">Web Designer</div>
                  </div>
                </div>
                <div class="col-12">
                  <a href="questionaire.html" class="btn btn-primary w-100">Verify Candidate</a>
                </div>
