...
$sql1="SELECT * FROM `candidates` WHERE `candidate_id`= '$id'";
...
<body>
  ...
  <main id="position" class="position">
    ...
    <section class="section profile" id="candidates-profile">
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo $pic?>" alt="Profile" class="rounded-circle">
              <h2><?php $name ?></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 fullName"><?php echo $name?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Role</div>
                    <div class="col-lg-9 col-md-8 role"><?php echo $role?></div>
                  </div>
                </div>
                <div class="col-12">
                  <a href="questionaire.php" class="btn btn-primary w-100">Verify Candidate</a>
                </div>
  ...
  <!-- ======= Footer ======= -->
  <footer id="footer" class="footer"  style="margin-top:21%;margin-left:-3%">
  ...
  <script>
    let displayAttributes=(row)=>{
        ...
        card1.querySelector('h2').innerText=fullName.innerText
        card1.querySelector('img').src=img.innerText
        card2.querySelector('.fullName').innerText=fullName.innerText
