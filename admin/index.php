...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      ...
      <img src="../uploads/pics/10.jpg" alt=""> 
          ...
          <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php $data="SELECT * FROM `reference`";
                      $qry1=mysqli_query($conn,$data)->num_rows;
                      echo $qry1;
                      ?></h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php
                      $data="SELECT * FROM `reference` WHERE `status`='Completed'";
                      $qry=mysqli_query($conn,$data)->num_rows;
                       $dif=$qry1-$qry;
                      echo $dif;
            ...
            <div class="col-12">
              <div class="card-body">
                ...
                $sql="SELECT * FROM `reference` ORDER BY `date_sent` DESC ";
                $data=mysqli_query($conn,$sql);
                for ( $x=0; $x<$data->num_rows;$x++){
                $row=$data->fetch_assoc();
                echo "  <tr>
                <th scope='col'>".$row['company_name']."</th>
                <td>".$row['ref_name']."</td>"?>
                
                <?php
                if ($row['status']=="") {
                 echo" <td class='badge bg-warning'>Pending</td>";
                }else{
                  echo " <td class='badge bg-success'>Completed</td>";
                }
                echo"
                <td>".$row['phone']."</td>
              </tr>";
...
<div class="activite-label">'.$row['time'].'</div>
<i class="bi bi-circle-fill activity-badge text-success align-self-start"></i>
<div class="activity-content">'.$row['description']
.'</div>
</div>';
